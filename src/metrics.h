...
class Metrics {
 public:
  ...
  struct Stats {
    ...
    // In-flight mutation blocking metrics for pure text queries
    std::atomic<uint64_t> query_in_flight_timeout_cnt{0};
    std::atomic<uint64_t> query_in_flight_wait_cnt{0};
  };
